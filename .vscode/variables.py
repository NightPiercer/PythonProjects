...
# Limited use variable names
#  yield = "yes"      ----> Reserved Words not allowed
# 3dVariable = "cube" ----> Starting with a number
# $testvariable = "$56" --> Starting with a symbol

#variable notation
# the_underscore_variable = "recommended by Python style guide"
# camelCaseVariable = "recommended by Scott"
# NEVER_GOING_TO_CHANGE_VARIABLE = "Scott"
...
# bigNumber = 99999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999
# print (bigNumber)

# Strings

# String assignment and position
